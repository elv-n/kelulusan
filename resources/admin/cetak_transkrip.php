<main class="flex-grow py-8">
    <div class="max-w-6xl mx-auto px-4 sm:px-6">
        <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
            <div>
                <h2 class="text-2xl font-semibold text-gray-900">Cetak Transkrip</h2>
                <p class="text-sm text-gray-500 mt-1">Cetak Transkrip Nilai Akademik per kelas</p>
            </div>
        ...
        <?php if ($kelas): ?>
            <div class="bg-white border border-gray-200 rounded-xl shadow-sm overflow-hidden">
                <div class="px-6 py-4 bg-gray-50 border-b border-gray-200 flex flex-col md:flex-row md:items-center justify-between gap-4">
                    ...
                    <div>
                        <a href="../generate_transkrip.php?kelas=<?= urlencode($kelas) ?>" target="_blank" class="inline-flex items-center px-4 py-2 bg-blue-600 text-white text-sm font-medium rounded-lg hover:bg-indigo-700 transition-colors shadow-sm">
                    ...
                    <table class="w-full">
                        <thead>
                            <tr class="bg-gray-50 border-b border-gray-200 text-left">
                                ...
                                <th class="px-3 py-2 text-center text-xs font-medium text-gray-500 uppercase w-56">Aksi</th>
                            </tr>
                        </thead>
                                    ...
                                    <tr class="hover:bg-gray-50 transition-colors border-b border-gray-100 last:border-0">
                                        ...
                                        <td class="px-3 py-1.5 text-center">
                                            <div class="flex items-center justify-center gap-1.5">
                                                <a href="skl_nilai.php?nisn=<?= $s['nisn'] ?>" class="inline-flex items-center whitespace-nowrap px-2 py-1 bg-blue-50 text-blue-700 text-[11px] font-bold rounded hover:bg-blue-100 transition-colors border border-blue-100">
                                                    Edit Nilai
                                                </a>
                                                <a href="../generate_transkrip.php?nisn=<?= $s['nisn'] ?>" target="_blank" class="inline-flex items-center whitespace-nowrap px-2 py-1 bg-emerald-50 text-emerald-700 text-[11px] font-bold rounded hover:bg-indigo-100 transition-colors border border-indigo-100">
                                                    Cetak Transkrip
                                                </a>
                                            </div>
                                        </td>
        ...
        <?php else: ?>
            <div class="text-center py-20 bg-white border border-dashed border-gray-300 rounded-xl">
                ...
                <p class="mt-1 text-sm text-gray-500">Silakan pilih kelas untuk menampilkan daftar siswa yang akan dicetak Transkrip-nya.</p>
            </div>
        <?php endif; ?>
    </div>
</main>